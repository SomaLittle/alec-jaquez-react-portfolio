...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiURl: "https://alecjaquez.devcamp.space/portfolio/portfolio_items",
      apiAction: "post"
    }
  ...
  componentDidUpdate() {
    ...
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiURl: `https://alecjaquez.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
        thumb_image_url: thumb_img_url || "",
